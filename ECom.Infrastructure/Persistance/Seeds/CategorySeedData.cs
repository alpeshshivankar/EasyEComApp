...
namespace ECom.Infrastructure.Persistance.Seeds
{
    public class SeedData
    {
        public static async Task Seed(InMemoryDbContext context)
        {
            ...
            {
                new CategoryEntity(){Id=1, CategoryName="Fruits & Vegetables",Description=""  },
                new CategoryEntity(){Id=2, CategoryName="Dairy & Eggs",Description=""  },
                new CategoryEntity(){Id=3, CategoryName="Meat & Seafood",Description=""  },
                new CategoryEntity(){Id=4, CategoryName="Bakery",Description=""  },
                new CategoryEntity(){Id=5, CategoryName="Pantry Staples",Description=""  },
                new CategoryEntity(){Id=6, CategoryName="Beverages",Description=""  },
                new CategoryEntity(){Id=7, CategoryName="Snacks & Confectionery",Description=""  },
                new CategoryEntity(){Id=8, CategoryName="Frozen Foods",Description=""  },
                new CategoryEntity(){Id=9, CategoryName="Cereals & Breakfast Foods",Description=""  },
                new CategoryEntity(){Id=10, CategoryName="Health & Wellness",Description=""  }
            };
