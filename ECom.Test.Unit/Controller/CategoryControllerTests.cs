...
namespace ECom.Test.Unit.Controller
{
    public class CategoryControllerTest
    {
        ...
        //[Fact]
        //public async Task WhenCreate_ShouldReturnCreatedAtActionResult_WhenCategoryIsCreated()
        //{
        //    CategoryDto categoryDto = new CategoryDto() { CategoryName = "Clothing", Description = "Apparel items" } ;
