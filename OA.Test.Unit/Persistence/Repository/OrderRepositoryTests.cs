...
namespace ECom.Test.Unit.Persistence.Repository
{
    public class OrderRepositoryTests
    {
        ...
        public void AddOrder_ShouldAddNewOrder()
        {
            ...
            var response = _orderRepository.Add(newOrder);
            var result = _orderRepository.GetById(response.Id);
        ...
        {
            var response = await _orderRepository.GetAll();
        ...
        {
            var orderToUpdate = _orderRepository.GetById(1);
            orderToUpdate.OrderDate = DateTime.Now.Date;
            _orderRepository.Update(orderToUpdate);
            var updatedOrder = _orderRepository.GetById(1);
